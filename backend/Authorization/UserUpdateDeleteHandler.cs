...
namespace Backend.Authorization
{
    ...
    public class UserUpdateCreateDeleteHandler : AuthorizationHandler<UserUpdateCreateDeleteRequirement>
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        public UserUpdateCreateDeleteHandler(IHttpContextAccessor httpContextAccessor)
        {
            _httpContextAccessor = httpContextAccessor;
        }
        protected override Task HandleRequirementAsync
            (AuthorizationHandlerContext context, UserUpdateCreateDeleteRequirement requirement)
        {
